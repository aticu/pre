...
/// A link to the documentation of the `pre_defs_for` attribute.
const PRE_DEFS_FOR_LINK: &str = concat!(docs_url!(), "/attr.assure.html");
...
pub(crate) fn generate_docs(
    ...
    if let Some(ctx) = &impl_block_context {
        ...
        doc!(
            docs,
            "This function was generated by an `impl` block inside a [`pre_defs_for` attribute]({}) that looked like this:",
            PRE_DEFS_FOR_LINK
        );
        doc!(docs);
...
/// Generates documentation of the preconditions for a `pre_defs_for` module.
pub(crate) fn generate_module_docs(module: &Module, path: &Path) -> Attribute {
    ...
    doc!(
        docs,
        "This module was generated by a [`pre_defs_for` attribute]({}).",
        PRE_DEFS_FOR_LINK
    );
